...
class CalendarIcon extends StatelessWidget {
  ...
  const CalendarIcon(this.number, this.onPressed, {super.key});
  @override
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Container(width: 28, height: 3.5, color: Colors.blue.shade600),
            Container(
              width: 28,
              height: 25,
              ...
              child: Center(
                child: Text("$number", style: ThemeText.datesLines),
              ),
            ),
          ],
        ),
